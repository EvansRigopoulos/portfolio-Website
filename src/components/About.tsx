        ...
        <div className="right-about">
          <div className="about-item">
            <div className="abt-text">
              ...
              <p className="small-text">
                Startup Acquisition & Transition Support
              </p>
            </div>
          </div>
          ...
          <div className="about-item">
            <div className="abt-text">
              <p className="large-text">1</p>
              <p className="small-text">
                Impact Award for Agile/Scrum Curriculum & Training (TPM Citrix)
              </p>
            </div>
          </div>
          <div className="about-item">
          ...
          <div className="about-item">
            <div className="abt-text">
              ...
              <p className="small-text">
                B2B Customer Support & Domain Expertise
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            <div className="timeline">
              ...
              <div className="timeline-item">
                ...
                <p>
                  Thesis: Academic Web Portal developed with HTML/CSS/JS and a
                  PHP/MySQL backend.
                </p>
              </div>
              <div className="timeline-item">
                ...
                <h5>
                  Certified Scrum Master (CSM)<span> - Scrum Alliance</span>
                </h5>
              </div>
              <div className="timeline-item">
                <div className="tl-icon">
